...
<head>
    ...
    <!-- Template Stylesheet -->
    <link href="<c:url value="template/tour/css/style.css"/>" rel="stylesheet">
</head>
                        ...
                        <div class="col-xl-6">
                            <form>
                                <div class="form-floating">
                                    ...
                                    <label for="select2">English</label>
                                </div>
                            </form>
                        </div>
                        <div class="col-xl-6">
                            <form>
                                <div class="form-floating">
                                    <select class="form-select bg-dark border" id="select3">
...
<script src="<c:url value="template/tour/lib/easing/easing.min.js"/>"></script>
<script src="<c:url value="template/tour/lib/waypoints/waypoints.min.js"/>"></script>
